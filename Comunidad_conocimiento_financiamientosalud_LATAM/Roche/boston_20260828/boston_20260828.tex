...
%   wpp2024_lac_broad_age_groups.png  (gráfica oficial ONU con pie de atribución; alternativa vectorial: ...pdf)
...
\begin{frame}{América Latina y el Caribe: población por grandes grupos de edad}
  \begin{center}
    % Imagen oficial de Naciones Unidas (PNG del sitio WPP 2024, byte a byte idéntico),
    % con su pie de atribución incrustado. No recortar.
    % Alternativa vectorial sin pie incrustado: {wpp2024_lac_broad_age_groups.pdf}
    \includegraphics[height=0.84\textheight]{wpp2024_lac_broad_age_groups.png}
  \end{center}
\end{frame}
