...
\unaccentedoperators % operadores sin acento: max, min, lim (la opción es-noaccentedoperators no existe en esta versión de babel)
...
\begin{frame}{Lectura sobre la gráfica: el mismo impuesto, dos repartos}
  ...
  \begin{tikzpicture}[x=0.68cm,y=0.62cm]
    \begin{scope}
      ...
      \fill[consum] (0,1.929) rectangle (1.829,3.214);
      \fill[produc] (0,1.414) rectangle (1.829,1.929);
      \ejes{6.4}{5.6}{$x$}{precio}
      \draw[demanda] (0,5.5) -- (4.4,0) node[above right,pos=0.9] {$D$};
      \draw[oferta] (0,0.5) -- (6,3.5) node[above,pos=0.97] {$S$};
      \draw[guia] (1.829,1.414) -- (1.829,0) (1.829,1.929) -- (2.857,1.929);
      \node[left] at (0,3.214) {$q$}; \node[left] at (0,1.929) {$p_0$}; \node[left] at (0,1.414) {$p$};
    ...
    \begin{scope}[xshift=7.5cm]
      ...
      \fill[consum] (0,2.167) rectangle (0.933,2.767);
      \fill[produc] (0,0.967) rectangle (0.933,2.167);
      \ejes{6.4}{5.6}{$x$}{precio}
      \draw[demanda] (0,3) -- (6,1.5) node[below,pos=0.95] {$D$};
      \draw[oferta] (0,0.5) -- (6,3.5) node[above,pos=0.97] {$S$};
      \draw[guia] (0.933,0.967) -- (0.933,0) (0.933,2.167) -- (3.333,2.167);
      \node[left] at (0,2.767) {$q$}; \node[left] at (0,2.167) {$p_0$}; \node[left] at (0,0.967) {$p$};
...
\begin{frame}{La teoría: con oferta de trabajo inelástica, la cuota recae sobre el salario}
  ...
  \begin{tikzpicture}[x=0.68cm,y=0.6cm]
    \begin{scope}
      ...
      \draw[oferta] (3.3,0) -- (3.95,5.2) node[right,pos=0.95] {$L^s$};
      \node[punto] at (3.568,2.145) {};
      \draw[guia] (0,2.236) -- (3.455,2.236) (0,1.236) -- (3.455,1.236) (3.455,1.236) -- (3.455,0);
      \draw[cuna] (0.45,1.236) -- (0.45,2.236);
      \node[right,cImpuesto] at (0.45,1.736) {cuña};
      \node[left] at (0,2.236) {$W$}; \node[left] at (0,1.236) {$w$};
    \end{scope}
    \begin{scope}[xshift=7.5cm]
      ...
      \draw[guia] (1.375,3.2) -- (1.375,0) (2.25,3.2) -- (2.25,0);
      \draw[decorate,decoration={brace,mirror,amplitude=4pt},thick] (1.375,-0.15) -- (2.25,-0.15) node[midway,below=4pt] {desempleo adicional};
    \end{scope}
  \end{tikzpicture}
  \par
  $W$: costo laboral; $w$: salario neto. Izquierda: el salario neto absorbe casi toda la cuota. Derecha: el neto no puede bajar y la cuota agrega desempleo.
...
\begin{frame}{El equilibrio con impuestos}
  Impuesto $t_{KX}$ al uso de capital en $X$ e impuesto $t_X$ al bien $X$; $c_X, c_Y$ son costos unitarios; $R$: ingreso.
  \begin{align*}
  ...
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      ...
      \begin{tikzpicture}[x=0.9cm,y=0.8cm]
        ...
        \draw[thin] (3.1,2.3) -- (4.3,2.15) node[right] {carga excesiva};
      \end{tikzpicture}
    \end{column}
    \begin{column}{0.43\textwidth}
      \begin{itemize}
...
\begin{frame}{Más elasticidad, más carga excesiva}
  ...
  \begin{tikzpicture}[x=0.68cm,y=0.6cm]
    \begin{scope}
      \node at (3.2,6.1) {Demanda inelástica};
      \fill[ce] (1.829,3.214) -- (1.829,1.414) -- (2.857,1.929) -- cycle;
      \ejes{6.4}{5.6}{$x$}{precio}
      \draw[demanda] (0,5.5) -- (4.4,0) node[above right,pos=0.9] {$D$};
      \draw[oferta] (0,0.5) -- (6,3.5) node[above,pos=0.97] {$S$};
      \draw[guia] (1.829,1.414) -- (1.829,0) (2.857,1.929) -- (2.857,0);
      \node[left] at (0,3.214) {$q$}; \node[left] at (0,1.414) {$p$};
    \end{scope}
    \begin{scope}[xshift=7.5cm]
      \node at (3.2,6.1) {Demanda elástica};
      \fill[ce] (0.933,2.767) -- (0.933,0.967) -- (3.333,2.167) -- cycle;
      \ejes{6.4}{5.6}{$x$}{precio}
      \draw[demanda] (0,3) -- (6,1.5) node[below,pos=0.95] {$D$};
      \draw[oferta] (0,0.5) -- (6,3.5) node[above,pos=0.97] {$S$};
      \draw[guia] (0.933,0.967) -- (0.933,0) (3.333,2.167) -- (3.333,0);
      \node[left] at (0,2.767) {$q$}; \node[left] at (0,0.967) {$p$};
    \end{scope}
  \end{tikzpicture}
  \par
...
\begin{frame}{Medir con la función de gasto}
  \begin{columns}[c]
    \begin{column}{0.5\textwidth}
      ...
      \end{align*}
      \pause
      La integral usa el lema de Shephard. La carga excesiva es el triángulo bajo la demanda hicksiana de la utilidad final.
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \begin{tikzpicture}[x=0.8cm,y=0.75cm]
        ...
        \ejes{6}{5.5}{$x$}{precio}
        \draw[demanda] (0,5) -- (5.5,0.6) node[above right,pos=0.85] {$x(p,R)$};
...
\begin{frame}{El IEPS a bebidas azucaradas es un impuesto específico por litro}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \end{tabular}
      \par\medskip
      {\small Se actualiza por inflación cada año desde 2018.}
    \end{column}
    ...
    \end{column}
  \end{columns}
  \fuente{DOF, 11-12-2013; LIEPS vigente, art.~2, fr.~I, inciso G (última reforma DOF 07-11-2025). Cuota de 2025: Acuerdo de actualización de cuotas del IEPS (DOF, 27-12-2024).}
\end{frame}
...
\begin{frame}{Cuando el impuesto corrige una falla, el triángulo cambia de signo}
  \begin{itemize}
    ...
    \pause
    \item La cuota de 2026 es 1.87 veces la de 2025; con la regla de la diapositiva 28, la carga excesiva crecería unas 3.5 veces, antes del argumento correctivo (con la misma elasticidad y la misma base).
    \pause
