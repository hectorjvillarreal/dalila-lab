---
doc_id: 202607_AURORA_AI_mollick_twilight-chatbots_v1.2
...
version: 1.2
supersedes: 202607_AURORA_AI_mollick_twilight-chatbots_v1.1
revision_summary: >
  Finding 3 corrected: web verification (2026-07-24, maintenance run) shows
  the June 2026 gatings of Fable 5 and GPT-5.6 were two separate actions
  under different instruments, unified by the 2026-06-02 covered-frontier-
  models EO — not one cross-lab intervention as the source states. The
  institutional-lurch mechanism survives in qualified form. Findings 1 and 2
  (incl. the v1.1 K3 amendment) unchanged. Action statuses updated.
project: Aurora
driver: AI
chat: Aurora-AI
type: corpus_entry
...
## Actions generated (statuses as of v1.2, 2026-07-24)
...
4. **PROTO-RAG-001 v1.1.** OPEN — standing decay convention corpus-wide;
   Debb's call.
5. **Nadella entry, China note.** GATED — update when the K3 weights are
   released and independently benchmarked (as of 2026-07-24: promised
   07-27, not yet public).
