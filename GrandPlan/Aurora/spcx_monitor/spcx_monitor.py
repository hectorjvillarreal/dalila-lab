...
def rebuild_run_log():
    ...
    lines = [
        ...
        "",
        "Provenance time series (PROTO-RAG-001). Each row is a state CHANGE: the "
        "date, the mechanism, the transition, and the observable that drove it. "
        "Days with no change are recorded as a heartbeat with the top-line flag.",
        "",
