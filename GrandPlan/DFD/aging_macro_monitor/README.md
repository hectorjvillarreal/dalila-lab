...
venues subtract. **ALERT** needs a macro term plus one quality signal (known series,
top venue, tracked author, or LAC geography); everything else with a core hit is
