...
$\beta > 0$ in every specification, in both countries. Within-cohort marriage
decline is \emph{smaller}, not larger, where the reference not-married share is
already high. The dynamics are stabilizing --- the sign is the opposite of the
cascade signature, and the pre-registered H$_{\text{cascade}}$ condition fails
comprehensively.
