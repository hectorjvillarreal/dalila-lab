...
equations~\eqref{eq:formation}--\eqref{eq:dissolution}, with the cohabiting
state's competing risks evaluated sequentially (dissolution first; conversion
conditional on remaining in union); (2) fertility-overlay
...
$c_0$ & cohab.$\to$marriage hazard, cond.\ on no dissolution (oldest cohorts) & 0.042 & 0.025 \\
