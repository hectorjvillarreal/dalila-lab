...
change in a pseudo-panel; the tempo margin is flagged, not resolved. The
Colombian ENDS event-history program is the designed resolution: true
union-transition hazards, including whether the 2019--22 shape residual
(Section~\ref{sec:results}) reflects sub-annual dynamics the annual cell
