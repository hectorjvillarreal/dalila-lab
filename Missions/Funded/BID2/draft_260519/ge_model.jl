...
function write_csv(hist, A_dom, L_new, C, M, Λvoid, Y, K, L, W)
    ...
    out_dir = @__DIR__
    open(joinpath(out_dir, "ge_lifecycle.csv"), "w") do io
    ...
    open(joinpath(out_dir, "ge_summary.csv"), "w") do io
    ...
    open(joinpath(out_dir, "ge_history.csv"), "w") do io
    ...
    println("  Wrote ge_lifecycle.csv, ge_summary.csv, ge_history.csv  (under $(out_dir))")
end
