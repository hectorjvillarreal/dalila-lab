...
\centering
\scriptsize
\caption{Marco macroeconómico: aprobado 2025, estimado 2025 y proyecto 2026}
\label{cua:C1_1}
\begin{tabular}{lrrr}
\toprule
\textbf{Variable} & \textbf{Aprobado 2025} & \textbf{Estimado 2025} & \textbf{Proyecto 2026} \\
\midrule
...
\bottomrule
\end{tabular}
\\[2pt]\begin{minipage}{0.92\textwidth}\scriptsize Fuente: CGPE 2026, Anexo II.5, p. 83. Elaborado por el ITED.\end{minipage}
\end{table}
