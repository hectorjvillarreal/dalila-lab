...
if [ -f _build/main.pdf ]; then
  cp _build/main.pdf _entrega/documento_2026.pdf
  echo "PDF: $(du -h _entrega/documento_2026.pdf | cut -f1), $(pdfinfo _entrega/documento_2026.pdf | awk '/^Pages/{print $2}') páginas"
else
