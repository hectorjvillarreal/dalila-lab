...
## Adenda 2026 — la rúbrica bajo régimen de lectura en vivo

La corrida 2026 produjo un documento del género **prohibiéndose toda pieza aprobada del ejercicio**. Los seis criterios se usaron como lista de exigencias sobre el propio texto y, además, la restricción reveló qué criterios dejan de ser aplicables. De ahí salen siete entradas.

**1. El criterio que el régimen en vivo cancela: la adjudicación de discrepancias.** Bajo lectura en vivo, cuando una cifra propia difiere de la de otro documento, **no se puede saber si la diferencia es de perímetro o de objeto**. Las tres verificaciones afectadas ---separar objeto de perímetro, medir lo que movió la Cámara, adjudicar un titular del proyecto contra el presupuesto ejercido--- exigen el aprobado del mismo ejercicio. **Se declaran en el documento, no solo en la bitácora**, y son una limitación del régimen y no de la corrida.

**2. Las dos líneas de comparación, y la obligación de etiquetarlas.** Se fija: **línea P** = proyecto t contra proyecto t−1 (ex ante contra ex ante); **línea G** = proyecto t contra aprobado t−1 (la del género, que mezcla objetos). Toda columna comparativa lleva su letra. La razón es cuantitativa. En 2026 la misma función educativa crece **3,4 %** en la línea P y **2,2 %** en la línea G, y el punto y dos décimas de diferencia son los 12,641.1 mdp que la Cámara añadió en diciembre de 2024 reapareciendo como base. En el **ejercicio 2025** la elección de línea cambiaba el signo: +0,81 % línea P, +0,70 % aprobado contra aprobado, **−0,47 %** línea G. Ninguna es falsa. **Corrección del 2026-09-07: el trío del signo es de 2025 y esta adenda lo atribuyó a 2026 al escribirse.** **Comparar el trío, nunca una sola de las tres entre ejercicios.**

**3. El diff de claves sube a criterio de rango alto en años de reclasificación.** Con 271 claves de programa que aparecen y 358 que desaparecen, el diff deja de ser control auxiliar. **Procedimiento: correr el diff ANTES de escribir cualquier variación**, y no publicar ningún recorte que el diff no explique. En 2026 el documento del género no menciona ni una vez la Guardia Nacional, el Ramo 47, el Ramo 56 ni reclasificación alguna ---cero apariciones en 85 páginas---, y con eso deja sin explicar una caída de 95,4 % real y sin atribuir un crecimiento de 12,3 %.

**4. Las cinco trampas de clave, y el corolario funcional.** La regla «por clave, nunca por nombre» **es insuficiente**. Verificadas en 2026: los nombres cambian (Pemex Consolidado → Petróleos Mexicanos); **la clave cambia de prefijo** (U316 → S316: cambia la modalidad, no el número); los programas se renumeran conservando el objeto (011 → 031 en salud del IMSS); los ramos enteros cambian de unidad responsable (Ramo 33, UR 420 → 411); y los organismos cambian de ramo todos los años (IMSS-Bienestar: 19, 47, 56). **Corolario: la única agregación estable es por función y subfunción**, que son catálogo nacional. Todo perímetro de rubro se define ahí primero.

**5. La capa demográfica declarada, con tier propio.** El vocabulario de tier pasa de tres valores a **cuatro**: `oficial_primaria`, `derivada_ciep`, `autoral_ited` y **`externa_demografica`**. Reglas: cuadros presupuestales y per cápita **separados**; toda cifra per cápita declara denominador, fuente y año; y **donde el denominador no se consiga, se declara y no se calcula, diciendo qué habría respondido**. La regla vieja ---no publicar per cápita sin denominador--- era correcta; **convertirla en no calcular per cápita fue un error, y costó dos descargas corregirlo.** Produjo el hallazgo mayor de la corrida: pensiones $-0,7$ % real en el agregado y $-4,8$ % por persona de 65 años y más.

**6. Excepción de régimen para las fuentes externas.** Un denominador externo publicado **después** de la entrega del paquete no se usa, aunque exista y sea mejor. En 2026 se usó el padrón de IMSS-Bienestar del segundo trimestre de 2025 y **no** el del cuarto, que es más exacto y se publicó después de la entrega. **Es una pérdida de precisión deliberada y es el precio de que el ejercicio sirva para lo que se hizo.**

**7. La compensación por inflación se presenta como rango, no como punto.** La corrida 2025 publicó un efecto neto de la inflación sobre el acervo de $-0,05$ puntos del PIB, calificado de «prácticamente cero». **Esa cifra sale de usar el mismo índice de precios en los dos lados de la identidad** ---el deflactor del PIB para diluir el denominador y para valuar el pago---, con lo que la cancelación es casi una identidad y no un hallazgo. **La rúbrica había declarado en 2023 que la cota de indexación no es identificable con el paquete, y el documento de 2025 publicó una cifra que la ignora.** Se fija: la compensación se presenta con su rango y su cota ---la línea de adecuaciones a registros presupuestarios, que es lo único que el paquete nombra---, nunca como punto. En 2026 el rango va de $-0,05$ a $-2,10$ puntos del PIB. **La descomposición de cuatro variables no cambia: la compensación es una lectura del requerimiento, no un término aditivo del marco.**

### Lo que 2026 confirma sobre el género, por tercer año

**El deflactor no declarado.** El ejemplar de 2026 usa **1,0365** ---la inflación promedio, no el deflactor del PIB de 4,8 % que declara el CGPE---, recuperado de tres programas independientes que cierran al decimal. **Toda variación real de su documento es unos 1,1 puntos porcentuales mayor que la misma cifra con el índice oficial.** El mismo hallazgo se hizo en 2025 (1,04252) y en 2024 (1,0480). **Ya no es un hallazgo: es un rasgo del género y la rúbrica lo trata como tal.**

**La columna de t−1 deflactada y rotulada como del año anterior.** Su gasto por afiliado «de 2025» de 8 596 pesos produce exactamente el 17,2 % real que reportan **solo si ya está en pesos de 2026**. Cuarto ejercicio consecutivo con el mismo patrón.

### Lo que no funcionó en 2026

**(a) Se tecleó de memoria dos veces.** Los renglones de la ILIF del año anterior ---cuatro de las primeras seis mal, por márgenes grandes--- y el monto de un ramo. Las dos veces se detectó al cotejar contra la fuente, antes de que llegara al texto. **La corrida 2025 registró este mismo incidente.** Regla reforzada: toda cifra entra al archivo de datos desde su fuente o no entra.

**(b) Se filtró por nombre y devolvió cero**, en las dos empresas del Estado. Es la trampa que partió el Ramo 38 en 2025. **Reincidencia, no novedad.**

**(c) Veintiuna inclusiones `\input` mal resueltas**, exactamente como en 2025 y en el mismo número. LaTeX las resuelve desde el directorio del archivo maestro. Las dos veces las encontró la comprobación estática y ninguna lectura del texto las habría revelado.

**(d) Una inferencia se escribió como medición.** La fase 0.5 atribuyó a «objeto» una diferencia de 10 021,1 mdp en un cuadro ajeno, razonando que su cifra era del proyecto y la nuestra del aprobado. **Con el archivo del proyecto en la mano ---encontrado una hora después--- resultó falso**: la Cámara no había tocado esa línea, y la diferencia sigue sin reconstruirse. La fila correcta es `no_verificable`. **Una inferencia bien argumentada sobre una fuente que no se tiene es una hipótesis y hay que rotularla como tal.** Es exactamente lo que este proyecto le señala al género desde 2020.

**(e) Un límite se derivó de una cifra redondeada.** El límite máximo de gasto corriente estructural se calculó como 10,9 % del PIB, tomado de una partida informativa. **No es un porcentaje del PIB:** se construye del devengado de la Cuenta Pública y de los deflactores, y el CGPE lo restituye en su texto. Es la prohibición de derivar de agregados redondeados, incumplida en un lugar nuevo.

## Adenda 2026-09-07 — la compuerta semántica

Sale de la comparación anónima del documento 2026 y es la primera entrada de la rúbrica que **no puede verificarse con una identidad contable**.

**8. El perímetro de la frase debe coincidir con el perímetro del cálculo.** Un agregado calculado sobre una clasificación, una función o dos capítulos del objeto del gasto **no puede nombrarse con la palabra general que designa al conjunto mayor**. Si el cálculo es de «pensiones y jubilaciones de la clasificación económica», la frase no dice «pensiones». Si es de los capítulos 6000 y 7000, la frase no dice «gasto de capital». Si compara dos tasas de crecimiento, dice que compara tasas y no montos.

**Por qué sube a criterio.** En 2026 **las treinta y tres identidades cerraron al peso y tres afirmaciones excedieron su perímetro**: pensiones cayendo cuando el bloque no contributivo crecía 12,1 %; «casi la mitad de todo el gasto de capital» por la mitad de dos capítulos; y «menos recursos condicionados» sobre un monto condicionado que aumenta. **Las identidades validan aritmética, no semántica.** Un documento puede cerrar perfectamente y contener un titular demasiado ancho.

**Procedimiento**, en `_aprendizaje/compuerta_semantica.md`: se aplica a cada titular, cada frase del resumen y cada pie de cuadro o figura, al cierre de cada capítulo y **antes de compilar**; se localiza el renglón de ficha del que sale la cifra; si el sujeto es más amplio que el perímetro **se reescribe la frase, no la ficha**; y se registra en la bitácora cuántas frases se reescribieron por capítulo. **Un conteo alto señala un perímetro mal declarado, no un redactor descuidado.**

**Corrida de prueba sobre el documento 2026, 2026-09-07: diez frases reescritas, ninguna cifra tocada.**

**9. Un ejemplo de método se verifica contra el capítulo del que sale.** La nota de método del documento 2026 ilustraba la regla de las dos líneas con el trío educativo +0,81 / +0,70 / −0,47 atribuyéndolo a 2026, cuando es del ejercicio 2025; el capítulo de Educación del propio documento publica +3,4 %. **Ninguna comprobación estática lo veía, porque las dos cifras son correctas en su lugar y sólo el vecindario las contradice.** Se fija: todo ejemplo numérico del frente declara de qué ejercicio y de qué capítulo sale, y se coteja contra ese capítulo en el mismo paso que la compuerta.

## Historial (continuación)
- 2026-09-07 · ejercicio 2026 · adenda (la rúbrica bajo régimen de lectura en vivo: el criterio que el régimen cancela; las dos líneas de comparación; el diff de claves como criterio de rango alto; las cinco trampas de clave; la capa demográfica con tier propio; la excepción de régimen para fuentes externas; la compensación por inflación como rango; el deflactor del género confirmado por tercer año; y cinco cosas que no funcionaron).
- 2026-09-07 · precarga 2027 · adenda (compuerta semántica como criterio; el ejemplo de método cotejado contra su capítulo; corrección de la atribución del trío educativo).
