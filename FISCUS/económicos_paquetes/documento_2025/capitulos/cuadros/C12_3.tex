...
\begin{tabular}{L{4.4cm}SSL{2.5cm}L{2.9cm}}
\toprule
{Objeto} & {2024} & {2025} & {Fuente} & {Qué es} \\
\midrule
{Endeudamiento neto interno del Gobierno Federal (techo)} & \num{1990000.0} & \num{1580000.0} & {ILIF art. 2o.} & {autorización, no gasto} \\
{Endeudamiento neto externo del sector público (techo, millones de dólares)} & \num{18000.0} & \num{15500.0} & {ILIF art. 2o.} & {en dólares, no en pesos} \\
{Endeudamiento neto interno del Gobierno Federal (partida informativa)} & \num{1906069.4} & \num{1576170.0} & {LIF art. 1o. renglón 0.01.01} & {lo que se preve ejercer} \\
