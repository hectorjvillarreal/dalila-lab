\begin{table}[htbp]
\centering
\caption{Perspectivas de finanzas públicas, 2024--2030 (\textbackslash\{\}\% del PIB)}
\label{tab:C12_2}
\small
...
Limite maximo de gasto corriente estructural & \num{9.8} & \num{10.1} & \num{10.1} & \num{10.1} & \num{10.1} & \num{10.1} & \num{10.1} & \num{10.1} & \num{0.0} \\
\bottomrule
\end{tabular}
\par\vspace{2pt}\footnotesize Fuente: elaboración propia del ITED con información de la SHCP, CGPE 2025, Anexo III.2, p.\textasciitilde{}85. El CGPE 2025 se publicó sin capa de texto; las cifras se leyeron de la página renderizada y se validaron por identidad contable.
\end{table}
