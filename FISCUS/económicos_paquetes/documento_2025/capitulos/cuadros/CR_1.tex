...
\num{7} & {Funcion Educacion / pensiones y jubilaciones} & {---} & {---} & \num{0.709} & \num{0.689} & \num{0.662} \\
\num{7} & {Funcion Educacion / pensiones totales (con no contributivas)} & {---} & {---} & \num{0.558} & \num{0.518} & \num{0.501} \\
\num{12} & {Costo financiero / impuestos} & {---} & \num{0.20} & \num{0.23} & \num{0.256} & \num{0.262} \\
\num{12} & {SHRFSPF / impuestos, en anios de recaudacion} & {---} & \num{3.6} & \num{3.4} & \num{3.4} & \num{3.51} \\
\bottomrule
\end{tabular}
